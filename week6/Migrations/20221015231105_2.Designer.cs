...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GebruikerMetGeslacht", b =>
                {
            ...
            modelBuilder.Entity("Geslacht", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("GeslachtString")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            GeslachtString = "Geheim"
                        },
                        new
                        {
                            Id = 4,
                            GeslachtString = "Anders"
                        });
                });

            modelBuilder.Entity("LikedBy", b =>
                {
            ...
            modelBuilder.Entity("LikedBy", b =>
                {
                    ...
                    b.HasOne("GebruikerMetGeslacht", "Gast")
                        .WithMany("likes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GebruikerMetGeslacht", null)
                        .WithMany()
